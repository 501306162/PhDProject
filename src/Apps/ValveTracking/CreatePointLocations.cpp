...
int main(int argc, char ** argv)
{
	...
	// load the input data 
	CMRFileExtractor::Pointer testDataLoader = CMRFileExtractor::New();
	testDataLoader->SetFolderName(inputDataFolder);
	testDataLoader->Extract();
	...
	PointLocations::Pointer pointLocations = PointLocations::Load("/home/om0000/ValveTracking/TrainingData/PointLocations.hdf5");
	PatchParams params("/home/om0000/ValveTracking/TrainingData/conf5/extract_features.json", true);
	params.timeStep = 0;

	
	// load the input data
	CMRFileExtractor::Pointer dataLoader = CMRFileExtractor::New();
	dataLoader->SetFolderName(argv[1]);
	...
	// load the point data
	PointData::Pointer pointModel = PointData::Load("/home/om0000/ValveTracking/SortedLines", testData->GetId(), true);
